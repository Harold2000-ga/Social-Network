...
export const Nav = () => {
  ...
  return (
    <>
      ...
      {nav && (
        <div className='nav-hamburger__shadow'>
          <div className={`nav-hamburger ${nav ? 'nav-hamburger-open' : ''}`}>
            <div className='nav-hamburger__header'>
              <div>
                <NavLink to={`profile/${auth._id}`} className='list-end__link-image'>
                  <Avatar className='list-end__img' item={auth} />
                </NavLink>
            ...
            <ul className='nav-hamburger_list'>
              <li className='hamburger__list-container' onClick={handleClick}>
